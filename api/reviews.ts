...
export async function fetchGooglePlacesReviews(forceRefresh = false): Promise<ReviewsApiResponse> {
  ...
  if (!apiKey) {
    ...
    return {
      ...
      averageRating: 5.0,
      totalReviews: 213,
      totalReviewCount: 213,
      displayedCount: 0,
      reviews: [],
      googleMapsUri: "https://www.google.com/maps/place/FANTASY+KING+(Designer)+alteration+%26+tailoring/@11.6762356,78.137468,17z/data=!3m1!4b1!4m6!3m5!1s0x3babf1a42dce11fb:0xcfe95d8a18e2f334!8m2!3d11.6762356!4d78.137468!16s%2Fg%2F11xf_c9fbr",
  ...
  if (result.business) {
    const response: ReviewsApiResponse = {
      ...
      googleMapsUri: result.business.googleMapsUri || "https://www.google.com/maps/place/FANTASY+KING+(Designer)+alteration+%26+tailoring/@11.6762356,78.137468,17z/data=!3m1!4b1!4m6!3m5!1s0x3babf1a42dce11fb:0xcfe95d8a18e2f334!8m2!3d11.6762356!4d78.137468!16s%2Fg%2F11xf_c9fbr",
