...
// Google "G" Icon component for official Google Maps attribution
...
export function ReviewsPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-surface text-on-surface overflow-x-hidden">
      <SEO
        title="5-Star Google Reviews | FANTASY KING Tailoring Salem"
        description="See authentic Google customer reviews and 5-star ratings for FANTASY KING designer tailoring and alterations in Salem."
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-16 text-center">
            ...
            >
              ...
              <h1 className="font-display-lg text-3xl sm:text-5xl md:text-6xl text-primary dark:text-white font-bold leading-tight mb-5">
                5-Star Customer Reviews for FANTASY KING
              </h1>
